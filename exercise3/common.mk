...
EXERCISE2 := $(MY_PATH)../exercise2
TESTING := $(MY_PATH)python_cpp_connection
INCLUDE1 := $(MY_PATH)../exercise1/include
INCLUDE2 := $(MY_PATH)../exercise2/include
LIB := $(MY_PATH)lib
...
#
override CXXFLAGS += -O3 -Wall -Wextra -MMD -I$(INCLUDE1) -I$(INCLUDE2) -I. -std=c++17 -fPIC
...
WITH_FLAGS := $(subst _FLAGS,,$(filter %_FLAGS,$(.VARIABLES)))
...
# if vars contain _FLAGS, add them to CXXFLAGS
$(foreach target, $(WITH_FLAGS), $(eval override CXXFLAGS += $($(target)_FLAGS)))
...
lcov:
	...
	lcov --directory $(MY_PATH)common/ --capture --output-file coverage/lcov.info
